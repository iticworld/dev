...
#ifndef   __NOVEMBERIZING__RED_BLACK_TREE__HH__
#define   __NOVEMBERIZING__RED_BLACK_TREE__HH__
...
namespace novemberizing
{
    namespace red
    {
        namespace black
        {
            ...
            protected:  typedef enum color color;
            protected:  class node
                        ...
                        public:     color c() const;
                        public:     void c(color v);
                        public:     node & operator=(const node & o);
                        public:     node & operator=(node && o) noexcept;
                        public:     node(const TUPLE & v, node * parent, color c);
                        public:     node(TUPLE && v, node * parent, color c);
                        public:     node();
            ...
            protected:  class fix
                        {
                        public:     static void insertion(tree<T, TUPLE> * t, node * n);
                        public:     static void deletion(tree<T, TUPLE> * t, node * parent);
                        public:     fix & operator=(const fix & o);
                        public:     fix & operator=(fix && o) noexcept;
                        public:     fix();
                        public:     fix(const fix & o);
                        public:     fix(fix && o) noexcept;
                        public:     virtual ~fix();
                        };
            protected:  class rotate
                        {
                        public:     static void left(tree<T, TUPLE> * t, node * n);
                        public:     static void right(tree<T, TUPLE> * t, node * n);
                        public:     rotate & operator=(const rotate & o);
                        public:     rotate & operator=(rotate && o) noexcept;
                        public:     rotate();
                        public:     rotate(const rotate & o);
                        public:     rotate(rotate && o) noexcept;
                        public:     virtual ~rotate();
                        };
            ...
            protected:  static color __color(node * n);
            protected:  static color __color(node * n, color c);
...
#include <novemberizing/red/black/tree.hp>
#include <novemberizing/red/black/tree/node.hp>
#include <novemberizing/red/black/tree/fix.hp>
#include <novemberizing/red/black/tree/rotate.hp>

#endif // __NOVEMBERIZING__RED_BLACK_TREE__HH__
