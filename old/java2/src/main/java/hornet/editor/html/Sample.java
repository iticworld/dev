...
public class Sample {
    public static String get(){
        return "<h2>Document No.${id}</h2>\n" +
                "  <p>\n" +
                "    <span style=\"text-decoration: line-through;\"><span style=\"text-decoration: underline;\">hello, </span></span>Collabee\n" +
                "  </p>\n" +
                "  <p>허 생원은<br />1<br />2<br />3<br />4<br /> 오늘 밤도 또 그 이야기를 끄집어내려는 것이다. 조 선달은 친구가 된 이래 귀에 못이 박히도록 들어왔다. 그렇다고 싫증은 낼 수도 없었으나 허 생원은 시치미를 떼고 되풀이할 대로는 되풀이하고야 말았다.</p>\n" +
